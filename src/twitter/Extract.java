...
public class Extract {
    ...
    public static Timespan getTimespan(List<Tweet> tweets) {
        ...
        Instant start = tweets.getFirst().getTimestamp();
        Instant end = tweets.getFirst().getTimestamp();
    ...
    public static Set<String> getMentionedUsers(List<Tweet> tweets) {
        ...
        for (Tweet tweet : tweets) {
            ...
            // Find all matches and add them to the set (to ensure uniqueness).
            while (matcher.find()) {
                // Extract the username without '@', convert to lowercase to handle case-insensitivity.
